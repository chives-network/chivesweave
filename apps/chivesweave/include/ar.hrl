...
%%% A collection of record structures used throughout the Chivesweave server.

%% True if chivesweave was launched with -setcookie=test
...
-define(RANDOMX_DIFF_ADJUSTMENT, (-2)).
-ifdef(DEBUG).
