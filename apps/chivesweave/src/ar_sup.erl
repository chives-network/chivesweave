...
-include_lib("chivesweave/include/ar_sup.hrl").
...
init([]) ->
	...
	ets:new(xwe_tx_blacklist, [set, public, named_table, {read_concurrency, true}]),
	ets:new(xwe_tx_blacklist_pending_headers,
			[set, public, named_table, {read_concurrency, true}]),
	ets:new(xwe_tx_blacklist_pending_data,
			[set, public, named_table, {read_concurrency, true}]),
	ets:new(xwe_tx_blacklist_offsets,
			[ordered_set, public, named_table, {read_concurrency, true}]),
	ets:new(xwe_tx_blacklist_pending_restore_headers,
			[ordered_set, public, named_table, {read_concurrency, true}]),
